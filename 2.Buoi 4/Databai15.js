...
for( i =0; i< hits.length;i++){
    c[i]=hits[i].jobTitle
    for(let y=0;y<hits[i].benefits.length;y++){
        (benefitValue=hits[i].benefits[y].benefitValue)
        allben.push(benefitValue)
    }
    allbenva.push( allben)
    allben=[]
}
...
console.log(c[i])
 ...
 for(let ii = 0;ii<allbenva[i].length; ii++){
console.log("-"+allbenva[i][ii])
}
}
...
let alljobti=[]
for(i=0;i<hits.length;i++){
    alljobti[i]=hits[i].jobTitle
}
//all locations
let allloca=[]
for(i=0;i<hits.length;i++){
    allloca[i]=hits[i].locations
}
//all skills
let allskill=[]
for(i=0;i<hits.length;i++){
    allskill[i]=hits[i].skills
}
//all Jobsalary
let allsala=[]
for(i=0;i<hits.length;i++){
    allsala[i]=hits[i].jobSalary
}
//Console.log all
for(i=0;i<hits.length;i++){
console.log(`-----------------------------------`)
console.log(`Tile: `+c[i])
console.log(`Salary: `+allsala[i])
console.log(`Location: \n- `+allloca[i])
console.log(`Benefits: `)
for(ii=0;ii<allbenva[i].length;ii++){
console.log(`- `+allbenva[i][ii])
}
console.log(`Skill: `)
for(ii=0;ii<allbenva[i].length;ii++){
    console.log(`- `+allskill[i][ii])
    }
}